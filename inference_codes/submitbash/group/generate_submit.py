...
for mode in ["ST", "GT", "GT+ST","allGT","allST"]:
    ...
    for da in da_list:
      ...
      for seq in ["01", "02"]:
        ...
        if da in da_2D_list:
              ...
              cmd = "python ./testSet/main_s2_78.py " + inputpath + " " + seq + " " + outputpath+ " " + da + " " + mode + " "+(all)+ "\n"
              file_all.write(cmd)


        else:

             cmd = "python ./testSet/main_s2_78_3D.py " + inputpath + " " + seq + " " + outputpath+ " " + da + " " + mode + " "+(all)+ "\n"
             file_all.write(cmd)
