...
__all__ = ['Crop', 'VerticalFlip', 'HorizontalFlip', 'Flip', 'Transpose',
           ...
           'GaussNoise', 'CLAHE', 'RandomGamma', 'ToFloat', 'Rotate', 'RandomRotate90','Rotate45',
...
class Rotate45(DualTransform):
    ...
    def __init__(self,limit=45, border_mode='reflect', cval=0.0,
                 always_apply=False, p=0.5):
        super(Rotate45, self).__init__(always_apply, p)
...
def scale(im, scale_x, scale_y, interpolation=BICUBIC):
...
aug_matcher = {
    ...
    'tofloat': ToFloat, 'rotate': Rotate, 'rotate45':Rotate45,'randomscale': RandomScale,
